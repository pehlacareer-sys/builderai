  ...
  return (
    ...
    >
      ...
      <div className={`flex-1 min-w-0 ${isUser ? 'text-right' : ''}`}>
        ...
        >
          <div className="prose prose-sm dark:prose-invert max-w-none break-words [&_pre]:bg-background [&_pre]:rounded-lg [&_pre]:p-3 [&_pre]:overflow-x-auto [&_code]:text-xs [&_h1]:text-base [&_h2]:text-sm [&_h3]:text-sm">
        ...
        <div className="flex gap-2 items-end">
          ...
          {isProcessing ? (
            ...
            <Button
              onClick={handleSend}
              disabled={!input.trim()}
              className="h-10 w-10 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white flex-shrink-0"
              size="icon"
            >
